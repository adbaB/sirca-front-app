    ...
    >
      ...
      <div className="col-span-5 flex items-center gap-3">
        ...
        <div className="min-w-0">
          ...
          <p className="text-xs truncate font-mono uppercase" style={{ color: '#6b7f6b' }}>
            Siglas: {portfolio.code}
          </p>
        </div>
      </div>
      ...
      <div className="col-span-2 flex items-center justify-end gap-1">
        <Can permission="update:portfolios">
          <button
        ...
        <Can permission="delete:portfolios">
          <button

...
export function MetadataVisor({
  ...
  return (
    <div className={`px-4 pb-4 pt-2 bg-[#f9faf9] border-t border-[#f1f5f1] animate-[slideDown_0.2s_ease-out] ${className}`}>
      <div className="bg-white p-3 rounded-lg border border-[#e2ebe2]">
        <div className="flex items-center gap-2 mb-3 pb-2 border-b border-[#f1f5f1]">
          ...
          <span className="text-xs font-bold uppercase tracking-wider text-[#1a2e1a]">
            {title}
          </span>
        </div>

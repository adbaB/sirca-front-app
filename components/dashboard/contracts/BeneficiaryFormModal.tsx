        ...
        <div className="flex flex-col gap-4">
          ...
          >
            ...
            <span className="mt-1 block text-xs" style={{ color: '#92400e' }}>
              Si continúa, el afiliado será <strong>removido</strong> de su contrato anterior para
              ser asociado a este.
            </span>
          </div>
          ...
          <div className="pt-2 border-t flex justify-end gap-3" style={{ borderColor: '#e2ebe2' }}>
            <Button
              type="button"
              variant="secondary"
